...
1. [Úvod](./01-uvod)
    ...
    * python
2. [Datové typy a podmínky](./02-datove_typy_a_podminky)
    * Datové typy Pythonu
    * Základní větvení programu pomocí podmínek
    * Přetypování
3. [Cykly a importy](./03-cykly_a_importy)
    * while cyklus
    * for cyklus
...
5. [Výjimky a práce se soubory](./06-vyjimky_a_prace_se_soubory)
    * výjimky včetně možnosti jejich vyhození
    * try/except blok
    * načtení souboru
    * zápis do souboru
6. [Úvod do objektově orientovaného programování](./07-oop_uvod)
    * základy OOP
